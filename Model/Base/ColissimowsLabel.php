...
use \Exception;
use \PDO;
use ColissimoHomeDelivery\Model\ColissimowsLabel as ChildColissimowsLabel;
use ColissimoHomeDelivery\Model\ColissimowsLabelQuery as ChildColissimowsLabelQuery;
use ColissimoHomeDelivery\Model\Map\ColissimowsLabelTableMap;
...
abstract class ColissimowsLabel implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\ColissimoHomeDelivery\\Model\\Map\\ColissimowsLabelTableMap';
    ...
    /**
     * The value for the label_data field.
     * @var        string
     */
    protected $label_data;
    ...
    /**
     * Initializes internal state of ColissimoHomeDelivery\Model\Base\ColissimowsLabel object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ColissimowsLabel</code> instance.  If
     * <code>obj</code> is an instance of <code>ColissimowsLabel</code>, delegates to
     * <code>equals(ColissimowsLabel)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     * @return   \ColissimoHomeDelivery\Model\ColissimowsLabel The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \ColissimoHomeDelivery\Model\ColissimowsLabel object", 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ColissimoHomeDelivery\Model\ColissimowsLabel (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \ColissimoHomeDelivery\Model\ColissimowsLabel Clone of current object.
     * @throws PropelException
     */
