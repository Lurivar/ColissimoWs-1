...
abstract class ColissimowsLabelQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \ColissimoHomeDelivery\Model\Base\ColissimowsLabelQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'thelia', $modelName = '\\ColissimoHomeDelivery\\Model\\ColissimowsLabel', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \ColissimoHomeDelivery\Model\ColissimowsLabelQuery) {
            return $criteria;
        }
        $query = new \ColissimoHomeDelivery\Model\ColissimowsLabelQuery();
        if (null !== $modelAlias) {
