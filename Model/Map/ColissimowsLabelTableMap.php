...
class ColissimowsLabelTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ColissimoHomeDelivery.Model.Map.ColissimowsLabelTableMap';
     ...
     */
    const OM_CLASS = '\\ColissimoHomeDelivery\\Model\\ColissimowsLabel';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ColissimoHomeDelivery.Model.ColissimowsLabel';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ColissimoHomeDelivery\\Model\\ColissimowsLabel');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ColissimoHomeDelivery\Model\ColissimowsLabel) { // it's a model object
